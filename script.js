...
if(!isNaN(document.getElementById("punkty_agresor").innerHTML)&&(!(isNaN(AGRESOR) || isNaN(WSZYSTKOWIEDZĄCY) || isNaN(MALKONTENT)||isNaN(GADUŁA)||isNaN( MILCZEK)||isNaN(DYPLOMATA))))
{
